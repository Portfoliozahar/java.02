...
class Infrastructure {
  ...
  Db init() {
    ...
    Cinema c4 = new Cinema(4, "Особенности национальной рыбалки", 3, 4);
    Cinema c5 = new Cinema(5, "Особенности национальной зимней рыбалки", 3, 4);
    Cinema c6 = new Cinema(6, "Человек паук", 3, 3);
    ...
    db.genres.add(new Genre(3, "Комендия"));
  ...
  public void search() {
    ...
    text = scanner.inputString("Поиск.");
    if (text.equals(""))
      ;
    else {
